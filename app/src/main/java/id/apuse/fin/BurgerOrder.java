...
import static id.apuse.fin.R.layout.activity_burger_order;
...
public class BurgerOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_burger_order);
    ...
    public void submitOrder(View view) {
        ...
        String priceMessage = "You Ordered " + quantity + " Burgers";
        Youtube.setText(priceMessage);
        Locale localeID = new Locale("in", "ID");
        NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
        TextView priceTextView = (TextView) findViewById(R.id.price_text_view);
        priceTextView.setText(formatRupiah.format(quantity * 25000));
