...
public class IcecreamOrder extends AppCompatActivity {

    int quantity = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_icecream_order);
    }
    ...
    public void submitOrder(View view){
        ...
        String priceMessage = "You Ordered " + quantity + " Ice Creams";
        Youtube.setText(priceMessage);
        Locale localeID = new Locale("in", "ID");
        NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
        TextView priceTextView = (TextView) findViewById(R.id.price_text_view);
        priceTextView.setText(formatRupiah.format(quantity * 15000));
